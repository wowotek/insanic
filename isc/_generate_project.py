...
def generate_project():
    ...
    # replace templates files content
    files = get_all_file(full_path)
    for i in files:
        print(f"replacing file {i}")
        replace_file(i, os.path.basename(full_path), conf.get("project_switches", "generate-model"))
